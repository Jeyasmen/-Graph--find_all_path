//c program to print all paths from
// a source to destination in  a weighted graph
#include <stdio.h>
// Creat strucure node
struct Node
{
...
//this function for adding the node
...
// this function add node in array from source to destination
...
int main() {
    ...
    int nodecount = 0;
    int n1=0, n2=0, c = 0;//initialization node1,node2 and cost
    ...
    printf ("start, end ? ");
    scanf ("%d %d", &start, &end);
    int list[50], clist[50], lcount = 0; // define array
    list[0] = start; clist[0] = 0; lcount = 1;// Initialization
